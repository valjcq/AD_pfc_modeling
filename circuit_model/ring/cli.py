...
def add_common_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--w_pyr_pyr_inter", type=float, default=4.0,
        help="Inter-node PYR->PYR weight (default: 4.0)",
    )
    parser.add_argument(
        "--sigma_pyr_deg", type=float, default=45.0,
        help="PYR ring connectivity width in degrees (default: 45)",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--delay_ms", type=float, default=3000.0,
        help="Delay duration after cue offset in ms (default: 3000)",
    )
    parser.add_argument(
