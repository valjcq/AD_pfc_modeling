"""
Tests for the ring_attractor module.

Run with: pytest tests/test_ring_attractor.py -v
"""
...
class TestRingParams:
    ...
    def test_default_values(self):
        ...
        assert params.w_pyr_pyr_inter == 1.5
...
class TestConnectivity:
    ...
    def test_pv_global_uniform(self):
        ...
        W = build_pv_global_weights(params)
...
class TestIntegration:
    ...
    def test_bump_forms_with_stimulus(self):
        ...
        # Get activity at end of stimulus
        t_end_stim = 300  # ms
        idx = int(t_end_stim / 0.5)
